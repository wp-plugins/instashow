<?php  
	...
	//	$user_data = file("https://api.instagram.com/v1/users/1731242/media/recent/?access_token=1731242.f59def8.8aff0efd7c45420581c07adcb1dc61f3");
		...
		include('style.php');
		$output = '<script src="' . plugins_url('/instashow/js/jquery-1.4.min.js', dirname(__FILE__)) . '" type="text/javascript" charset="utf-8"></script>
		<script src="' . plugins_url('/instashow/js/loopedslider.js', dirname(__FILE__)) . '" type="text/javascript" charset="utf-8"></script>
		<div id="insta_loopedSlider">
		<a href="#" class="insta_previous">previous</a>
		<a href="#" class="insta_next">next</a>
		<div id="insta_wrap">
		<div class="insta_container">
		<div class="insta_slides">';
		for($k=0;$k < $imagescount; $k++) {
		//	if($k % 2 != 0) { $color = 'style="background: #eee;"';} else { $color = ' ';}
