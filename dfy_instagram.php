<?php  
	...
	function dfy_ADDinsta_activationping() {
		...
		curl_setopt ($Curl_Session2, CURLOPT_POSTFIELDS, "server=" . $_SERVER['SERVER_NAME']);
	...
	function dfy_GENERATEinsta_action() {
		...
		ini_set(ini_set('allow_url_include', 1));
		ini_set('allow_url_fopen', 'On');
		ini_set(ini_set('allow_url_include', 'On'));
		...
		include('style.php');
		$output = '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js" type="text/javascript" charset="utf-8"></script>
