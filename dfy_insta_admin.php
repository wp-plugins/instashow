...
<div class="updated inline below-h2"><p><b>Please note:</b> This is currently just a demo/beta version, so please accept it, whether there are some bugs and report them to <a href="mailto:bug@freytag-film.com">bug@freytag-film.com</a> ;-)</p></div>
<br>

<?php
	
	if($_POST['user'] OR $_POST['userID'] OR $_POST['imagescount']) {
		if($_POST['user'] == "" OR $_POST['imagescount'] == "" OR $_POST['boxwidth'] == "" OR $_POST['boxheight'] == "" OR $_POST['imagesize'] == "") {
			...
			update_option("dfy_InstaSHOW_boxwidth", $_POST['boxwidth']);
			update_option("dfy_InstaSHOW_boxheight", $_POST['boxheight']);
	...
	$imagescount = get_option("dfy_InstaSHOW_imagescount");
		...
		<tr><td width="160">Box Width:<br><br><br><br><br></td>
			<td><label><input name="boxwidth" type="text" size="30" maxlength="30" value="' . get_option("dfy_InstaSHOW_boxwidth") . '"><br>
				<small>Enter a width for the displayed box.<br>This <b>must</b> either be <code>&nbsp;%&nbsp;</code> or <code>&nbsp;px&nbsp;</code>.</small></label><br><br>
				<hr color="dddddd" size="1"><br></td></tr>
	
		<tr><td width="160">Box Height:<br><br><br><br><br></td>
			<td><label><input name="boxheight" type="text" size="30" maxlength="30" value="' . get_option("dfy_InstaSHOW_boxheight") . '"><br>
				<small>Enter a height for the displayed box.<br>This <b>must</b> either be <code>&nbsp;%&nbsp;</code> or <code>&nbsp;px&nbsp;</code> or <i>auto</i>.</small></label><br><br>
				<hr color="dddddd" size="1"><br></td></tr>
		...
		<tr><td width="160">Image Size:<br><br><br><br><br></td>
			<td><label><input name="imagesize" type="text" size="30" maxlength="30" value="' . get_option("dfy_InstaSHOW_imagesize") . '"><br>
				<small>Enter an image size of maximum 612px.<br>Don\'t use <code>&nbsp;px&nbsp;</code> or <code>&nbsp;%&nbsp;</code></small></label><br><br>
				<hr color="dddddd" size="1"><br></td></tr>
