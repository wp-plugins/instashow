...
<br><div class="updated inline below-h2"><p><b>Please note:</b> This is just version 1.0, so please accept it, whether there are some bugs and report them to <a href="mailto:bug@freytag-film.com">bug@freytag-film.com</a> ;-)</p></div>
<br><br>

<?php
	
// Check whether we need to update or not - user+token
	if($_POST['username'] OR $_POST['userID'] OR $_POST['imagescount']) {
	...
	// Error detection
			if(isset($keycode->message)) { echo('Sorry, your username or password is wrong!');} else {
	...
	// save to DB 1
			...
			if(($_POST['imagescount'] == "" OR $_POST['textsize'] == "" OR $_POST['imagesize'] == "") AND (!isset($keycode->message))) {
	...
	echo'<table width="100%"><tr><td width="550" valign="top"><form method="post">
		...
		<tr><td width="160">Set your Instagram username<br>and password ONCE:<br><br><br><br></td>
		...
		<tr><td></td><td><input type="submit" name="Submit" class="button-primary" value=" Save changes "><br></td></tr></table></div>
	...
	<small><u>Warning:</u> Only for advanced users!<br>Enter additional style tags for the <code>&#060;div&#062;</code> tag.</small></label><br><br></td></tr>
		...
		<tr><td></td><td><input type="submit" name="Submit" class="button-primary" value=" Save changes "><br><br></td></tr></table></div>
